...
<body class="bg-gray-50">
    ...
    <header class="bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-lg sticky top-0 z-50">
        <div class="container mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl md:text-3xl font-bold cursor-pointer" id="storeName" onclick="showHome()">Mi Tienda</h1>
    ...
    <div id="homeView">
        <div class="container mx-auto px-4 py-6">
            <div class="max-w-2xl mx-auto">
                <input 
                    ...
                    class="w-full px-4 py-3 rounded-lg border-2 border-gray-300 focus:border-blue-500 focus:outline-none shadow-sm"
        ...
        <div class="container mx-auto px-4 pb-6">
            <div class="flex flex-wrap gap-2 justify-center" id="categoriesContainer"></div>
        </div>
    ...
    <div id="productDetailView" class="hidden">
        <div class="container mx-auto px-4 py-4">
            <button onclick="showHome()" class="text-blue-600 hover:text-blue-700 font-semibold">
                ← Volver a la tienda
            </button>
        </div>

        <div id="productDetailContent" class="container mx-auto px-4 pb-8"></div>

        <div class="bg-white py-12 border-t border-b">
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                    ...
                    <p class="text-gray-400">Tu tienda online de confianza. Calidad y servicio garantizados.</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p class="text-gray-400">Atención: Lun - Dom 9:00 AM - 9:00 PM</p>
                </div>
            </div>
    ...
    <script>
        ...
        function renderPagination(totalProducts) {
            ...
            if (currentPage > 1) {
                paginationHTML += `<button onclick="changePage(${currentPage - 1})" class="px-4 py-2 bg-white rounded-lg shadow hover:bg-gray-100 transition font-semibold">← Anterior</button>`;
            }
            ...
            if (currentPage < totalPages) {
                paginationHTML += `<button onclick="changePage(${currentPage + 1})" class="px-4 py-2 bg-white rounded-lg shadow hover:bg-gray-100 transition font-semibold">Siguiente →</button>`;
            }
        ...
        function sendToWhatsApp() {
            ...
            cart.forEach(item => {
                ...
                message += `   Subtotal: ${storeData.negocio.moneda} ${(item.precio * item.quantity).toFixed(2)}\n\n`;
            });
